...
const PJYSDK = (function(){
    function PJYSDK(app_key, app_secret){
        ...
        this.debug = true;
        this._lib_version = "v1.16";
        this._protocol = "http";
        this._hosts = ["api3.paojiaoyun.com", "api6.paojiaoyun.com", "api.paojiaoyun.com", "api2.paojiaoyun.com"];
        ...
        this._heartbeat_gap = 10 * 1000; // 默认600秒
    ...
    catch (error) {toastLog("无法连接服务器,如存在VPN请关闭VPN")
    ...
    PJYSDK.prototype.CardLogin = function() {  // 卡密登录
        ...
        if (ret.code == 0) {
            ...
            this._heartbeat_gap = ret.result.hg*1000;
